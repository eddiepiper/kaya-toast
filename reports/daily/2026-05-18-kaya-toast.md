...
- AI governance is product work, not only policy work (reject, final score 8)
- AI governance is product work, not only policy work (reject, final score 8)
...
- AI can speed discovery only when PMs protect evidence quality: no clear PM content angle; recommendation reject
